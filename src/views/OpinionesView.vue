<template>
    <div id="OpinionesView">
        <h1 class="letra">Componente OpinionesView</h1>
        <p class="letra">Escribe tu opinión para el juego: {{ nombre }}</p>
        <hr>
        ...
        <hr>
        <h2 class="letra">A continuación podrás ver tu opinión</h2>
        <div id="sinOpiniones" v-if="cantidadOpiniones<1">
            <p class="letra">No existen opiniones para mostrar</p>
        </div>
        <hr>
        ...
        <div class="accordion" id="accordionExample" v-if="cantidadOpiniones>0">
            <div class="accordion-item" v-for="(elemento,index) in opiniones">
                ...
                <button class="accordion-button btnAgregar" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
